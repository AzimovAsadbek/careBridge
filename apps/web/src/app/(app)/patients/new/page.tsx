...
export default function NewPatientPage() {
  ...
  return (
    <>
      <PageHeader back={{ href: '/patients', label: 'Patients' }} title="New patient" subtitle="Register a patient admitted to your facility." />
      <Card className="max-w-2xl">
        <form onSubmit={submit} className="grid gap-4 sm:grid-cols-2">
          ...
          <Field label="Phone" htmlFor="phone" optional><Input id="phone" type="tel" inputMode="tel" pattern="\+?[0-9 ()\-]{7,20}" value={form.phone} onChange={set('phone')} /></Field>
          ...
          <div className="sm:col-span-2">
            <Field label="Admission note" htmlFor="dx" optional hint="Short clinical context"><Textarea id="dx" rows={2} maxLength={500} value={form.diagnosisNote} onChange={set('diagnosisNote')} /></Field>
          </div>
